...
func TestKeeper_WithdrawSP(t *testing.T) {
	...
	require.Equal(t, "5sp", set.bankKeeper.GetBalance(ctx.Context, addr1, scorumtypes.SPDenom).String())
	require.Equal(t, "5scr", set.bankKeeper.GetBalance(ctx.Context, addr1, scorumtypes.SCRDenom).String())
	...
	require.Equal(t, "993sp", set.bankKeeper.GetBalance(ctx.Context, addr4, scorumtypes.SPDenom).String())
	require.Equal(t, "7scr", set.bankKeeper.GetBalance(ctx.Context, addr4, scorumtypes.SCRDenom).String())

	set.keeper.WithdrawSP(ctx.Context, 20)
	require.Equal(t, "5sp", set.bankKeeper.GetBalance(ctx.Context, addr1, scorumtypes.SPDenom).String())
	require.Equal(t, "5scr", set.bankKeeper.GetBalance(ctx.Context, addr1, scorumtypes.SCRDenom).String())
	require.Equal(t, "5sp", set.bankKeeper.GetBalance(ctx.Context, addr2, scorumtypes.SPDenom).String())
	require.Equal(t, "105scr", set.bankKeeper.GetBalance(ctx.Context, addr2, scorumtypes.SCRDenom).String())
