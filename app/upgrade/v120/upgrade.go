...
func (p *Params) ParamSetPairs() paramtypes.ParamSetPairs {
	...
	return paramtypes.ParamSetPairs{
		...
		paramtypes.NewParamSetPair(scorumtypes.KeySPWithdrawalTotalPeriods, &p.SpWithdrawalTotalPeriods, noValidate),
		paramtypes.NewParamSetPair(scorumtypes.KeySPWithdrawalPeriodDurationSeconds, &p.SpWithdrawalPeriodDurationSeconds, noValidate),
...
func Handler(
	...
	return func(ctx context.Context, _ upgrade.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
		...
		ps.SetParamSet(sdkCtx, &scorumtypes.Params{
			...
			SpWithdrawalTotalPeriods:          old.SpWithdrawalTotalPeriods,
			SpWithdrawalPeriodDurationSeconds: old.SpWithdrawalPeriodDurationSeconds,
